...
namespace octree {
    ...
    public:
        ...
        [[nodiscard]] std::shared_ptr<Octree> octreeUnion(const std::shared_ptr<octree::Octree> &other) const;

        [[nodiscard]] std::shared_ptr<Octree> octreeIntersection(const std::shared_ptr<octree::Octree> &other) const;
    };
}
