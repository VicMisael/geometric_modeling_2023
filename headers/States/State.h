...
public:
    ...
    virtual void Update(float deltaTime, GLFWwindow* janela, Camera* camera, Shader* shader){ }
...
public:
    ...
    void Update(float deltaTime, GLFWwindow* janela, Camera* camera, Shader* shader){
        if(this->estado == "View"){
